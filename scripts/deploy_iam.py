...
LAMBDA_POLICY = {
    ...
    "Statement": [
        ...
        {"Effect": "Allow", "Action": ["s3:GetObject"], "Resource": "arn:aws:s3:::cvgram-cv-bucket/*"},
        {"Effect": "Allow", "Action": ["textract:*"], "Resource": "*"},
        {"Effect": "Allow", "Action": ["comprehend:*"], "Resource": "*"},
        {"Effect": "Allow", "Action": ["dynamodb:PutItem", "dynamodb:UpdateItem"], "Resource": "arn:aws:dynamodb:*:*:table/CVs"}
    ]
}
